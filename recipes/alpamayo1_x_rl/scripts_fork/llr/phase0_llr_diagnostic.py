...
Usage::
    ...
    for i in 0 1 2 3; do
      CUDA_VISIBLE_DEVICES=$((4+i)) a1x_rl_b300/bin/python scripts_fork/llr/phase0_llr_diagnostic.py \\
...
Smoke test (single GPU, 8 events)::
    ...
    CUDA_VISIBLE_DEVICES=0 a1x_rl_b300/bin/python scripts_fork/llr/phase0_llr_diagnostic.py \\
